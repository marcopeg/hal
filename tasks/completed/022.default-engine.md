...
Superseded on 2026-03-10.

This task was intentionally not implemented. The setup wizard and current configuration flow now cover engine selection/configuration, so an additional interactive boot-time auto-detection flow is no longer needed.
